  ...
  // Import zdjęć
  import Caruzel1 from '../photo/Caruzel1.webp'; 
  import Caruzel2 from '../photo/Caruzel2.webp';
  import Caruzel3 from '../photo/Caruzel3.webp'; 
  ...
  <div 
    ...
    style={{
      ...
      top: isMobile ? `${y - 130}px` : `${y - 50}px`,

      left: isMobile ? `${x - 50}px` : `${x - 50}px`, 
